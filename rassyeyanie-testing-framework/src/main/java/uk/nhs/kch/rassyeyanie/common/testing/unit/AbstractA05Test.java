...
public class AbstractA05Test extends AbstractHl7Test {

	public AbstractA05Test(String actualSourcePath, String expectedPath) {
	...
	@Test
	public void test_message_to_message_gt1_1() throws Exception {
		testStructureByIndex(0, GT1.class);
	}

	@Test
	public void test_message_to_message_gt1_2() throws Exception {
		testStructureByIndex(1, GT1.class);
