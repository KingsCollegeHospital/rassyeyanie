    ...
    implements ProtocolEncoder
{
    ...
    private static final transient Logger LOG = LoggerFactory
        .getLogger(HL7MLLPEncoder.class);
        ...
        throws Exception
    {
        ...
        {
            body =
                HL7Converter.encode((Message) message, this.config.getParser());
        }
        ...
        ByteBuffer buf = ByteBuffer.allocate(body.length()).setAutoExpand(true);
        ...
        buf.flip();
        LOG.debug("Encoding HL7 from {} to byte stream", message
            .getClass()
            .getCanonicalName());
        out.write(buf);
    }
