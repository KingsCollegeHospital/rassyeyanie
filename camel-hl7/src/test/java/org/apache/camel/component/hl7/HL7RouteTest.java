    ...
    extends CamelTestSupport
{
    ...
    @Test
    public void testSendA19()
        throws Exception
    {
        MockEndpoint mock = this.getMockEndpoint("mock:a19");
        ...
        String out =
            (String) this.template.requestBody(
                "mina:tcp://127.0.0.1:8888?sync=true&codec=#hl7codec",
                in.toString());
        
        String[] lines = out.split("\r");
        assertEquals(
            "MSH|^~\\&|MYSENDER||||200701011539||ADR^A19||||123",
            lines[0]);
    ...
    @Test
    public void testSendA01()
        throws Exception
    {
        MockEndpoint mock = this.getMockEndpoint("mock:a01");
        mock.expectedMessageCount(1);
        mock.message(0).body().isInstanceOf(Message.class);
        
        String line1 =
            "MSH|^~\\&|MYSENDER|MYSENDERAPP|MYCLIENT|MYCLIENTAPP|200612211200||ADT^A01|1234|P|2.4";
        ...
        String[] lines = out.split("\r");
        assertEquals(
            "MSH|^~\\&|MYSENDER||||200701011539||ADT^A01||||123",
            lines[0]);
        ...
        return new RouteBuilder() {
                ...
                throws Exception
            {
                ...
                this
                    ...
                    .when(this.header("CamelHL7TriggerEvent").isEqualTo("A19"))
                    .beanRef("hl7service", "handleA19")
                    .to("mock:a19")
                    // and A01 should invoke the handleA01 method on our
                    // hl7service bean
                    .when(this.header("CamelHL7TriggerEvent").isEqualTo("A01"))
                    .to("mock:a01")
    ...
    public class MyHL7BusinessLogic
    {
        ...
        public Message handleA19(Message msg)
            throws Exception
        {
        ...
        public Message handleA01(Message msg)
            throws Exception
        {
    ...
    private static Message createADR19Message()
        throws Exception
    {
