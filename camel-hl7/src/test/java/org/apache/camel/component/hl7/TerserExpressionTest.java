...
public class TerserExpressionTest extends CamelTestSupport {
    ...
    public void testNextPatientIdInResultMessage() throws Exception {
        BufferedReader in =
                IOHelper.buffered(new InputStreamReader(this
                    .getClass()
                    .getResourceAsStream("/oru_r01.txt")));
            String line = "";
            String message = "";
            while (line != null)
            {
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        ...
        return new RouteBuilder() {
            public void configure() throws Exception {
                ...
                from("direct:test6").unmarshal().hl7().bean(new NestedTerserBean()).to("mock:test6");
            }
        };
    }
    ...
    public class NestedTerserBean {
    	public String patientId(@Terser(value = "/.PID-3(0)") String patientId) {  
    		return patientId;
    	}
    }
}
